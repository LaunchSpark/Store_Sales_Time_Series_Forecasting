...
build_preprocessor <- function(train_predictors) {
  ...
  clean_feature_names <- function(nms) make.names(nms, unique = TRUE)
  colnames(train_design) <- clean_feature_names(colnames(train_design))
  ...
  list(
    feature_names = colnames(train_design),
...
apply_preprocessor <- function(df, preproc) {
  ...
  design <- design[, preproc$feature_names, drop = FALSE]
