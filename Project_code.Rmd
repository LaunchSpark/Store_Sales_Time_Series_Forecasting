...
if (length(missing_packages) > 0) {
  ...
  if (is.null(cran_repo) || identical(cran_repo, structure("@CRAN@", names = "CRAN")) || cran_repo["CRAN"] == "@CRAN@") {
...
You can explore `keras` (LSTM/GRU) later by preparing sequence windows per series and fitting a 3D tensor model. Start with the global Random Forest above for a strong baseline.
...
pred_test_log <- predict(rf_final, data = test_baked)$predictions
