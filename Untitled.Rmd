...
After baking the recipe we train an XGBoost model, monitoring validation
RMSE via an explicit watchlist and using early stopping to control model
complexity. This gradient-boosted tree ensemble captures nonlinear
relationships in the engineered feature space.
